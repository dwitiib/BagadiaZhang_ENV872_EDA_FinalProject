...
AsthmaDemo.points = ggplot(NY_Asthma_Demo_join, aes(y = log(VisitRate), x =log(NonWhiteDens))) + 
...
AsthmaDemo.regression = lm(data = NY_Asthma_Demo_join, log(VisitRate) ~ log(NonWhiteDens))
