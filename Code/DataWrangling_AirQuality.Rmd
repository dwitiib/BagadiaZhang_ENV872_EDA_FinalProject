...
NY_Ozone_clean1 = NY_Ozone_clean %>% 
  group_by(County.Name) %>% 
  summarise(meanOzone = mean(AQI))
colnames(NY_Ozone_clean1) = c("County", "meanOzone")
colnames(NY_Ozone_clean) = c("County", "Latitude", "Longitude", "Datum", "AQI")
...
NY_SO2_clean1 = NY_SO2_clean %>% 
  filter(Sample.Duration == "1 HOUR") %>% 
  group_by(County.Name) %>% 
  summarise(meanSO2 = mean(AQI))
colnames(NY_SO2_clean1) = c("County", "meanSO2")
colnames(NY_SO2_clean) = c("County", "Latitude", "Longitude", "Datum", "AQI")
...
NY_CO_clean1 = NY_CO_clean %>% 
  filter(Sample.Duration == "8-HR RUN AVG END HOUR") %>% 
  group_by(County.Name) %>% 
  summarise(meanCO = mean(AQI))
colnames(NY_CO_clean1) = c("County", "meanCO")
colnames(NY_CO_clean) = c("County", "Latitude", "Longitude", "Datum", "AQI")
...
NY_NO2_clean1 = NY_NO2_clean %>% 
  group_by(County.Name) %>% 
  summarise(meanNO2 = mean(AQI))
colnames(NY_NO2_clean1) = c("County", "meanNO2")
colnames(NY_NO2_clean) = c("County", "Latitude", "Longitude", "Datum", "AQI")
...
NY_PM25_clean1 = NY_PM25_clean %>% 
  filter(Sample.Duration == "24-HR BLK AVG") %>% 
  group_by(County.Name) %>% 
  summarise(meanPM25 = mean(AQI))
colnames(NY_PM25_clean1) = c("County", "meanPM25")
colnames(NY_PM25_clean) = c("County", "Latitude", "Longitude", "Datum", "AQI")
...
NY_PM10_clean1 = NY_PM10_clean %>% 
  group_by(County.Name) %>% 
  summarise(meanPM10 = mean(AQI))
colnames(NY_PM10_clean1) = c("County", "meanPM10")
colnames(NY_PM10_clean) = c("County", "Latitude", "Longitude", "Datum", "AQI")
...
write.csv(NY_Ozone_clean1, "./Data/ProcessedData/NY_Ozone_processed.csv", row.names = FALSE)
write.csv(NY_SO2_clean1, "./Data/ProcessedData/NY_SO2_processed.csv", row.names = FALSE)
write.csv(NY_CO_clean1, "./Data/ProcessedData/NY_CO_processed.csv", row.names = FALSE)
write.csv(NY_NO2_clean1, "./Data/ProcessedData/NY_NO2_processed.csv", row.names = FALSE)
write.csv(NY_PM25_clean1, "./Data/ProcessedData/NY_PM25_processed.csv", row.names = FALSE)
write.csv(NY_PM10_clean1, "./Data/ProcessedData/NY_PM10_processed.csv", row.names = FALSE)
write.csv(NY_Ozone_clean, "./Data/ProcessedData/NY_Ozonemonitor_processed.csv", row.names = FALSE)
write.csv(NY_SO2_clean, "./Data/ProcessedData/NY_SO2monitor_processed.csv", row.names = FALSE)
write.csv(NY_CO_clean, "./Data/ProcessedData/NY_COmonitor_processed.csv", row.names = FALSE)
write.csv(NY_NO2_clean, "./Data/ProcessedData/NY_NO2monitor_processed.csv", row.names = FALSE)
write.csv(NY_PM25_clean, "./Data/ProcessedData/NY_PM25monitor_processed.csv", row.names = FALSE)
write.csv(NY_PM10_clean, "./Data/ProcessedData/NY_PM10monitor_processed.csv", row.names = FALSE)
```
