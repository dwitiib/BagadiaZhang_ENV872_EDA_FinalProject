...
AsthmaDemo.points = ggplot(NY_Asthma_Demo_join, aes(y = log(NonWhiteDens), x =VisitRate)) + 
...
AsthmaDemo.regression = lm(data = NY_Asthma_Demo_join, log(NonWhiteDens) ~ VisitRate)
summary(AsthmaDemo.regression)
plot(AsthmaDemo.regression,1)
plot(AsthmaDemo.regression,2)
plot(AsthmaDemo.regression,3)
plot(AsthmaDemo.regression,4)
